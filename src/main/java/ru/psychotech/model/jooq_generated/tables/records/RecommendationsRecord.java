...
public class RecommendationsRecord extends UpdatableRecordImpl<RecommendationsRecord> implements Record3<Long, Long, String> {
    ...
    public Field<Long> field1() {
        return Recommendations.RECOMMENDATIONS.ID;
    }

    @Override
    public Field<Long> field2() {
        return Recommendations.RECOMMENDATIONS.DIAGNOSTIC_ID;
    }

    @Override
    public Field<String> field3() {
        return Recommendations.RECOMMENDATIONS.TEXT;
    }
    ...
    @Override
    public RecommendationsRecord value1(Long value) {
        setId(value);
        return this;
    }

    @Override
    public RecommendationsRecord value2(Long value) {
        setDiagnosticId(value);
        return this;
    }

    @Override
    public RecommendationsRecord value3(String value) {
        setText(value);
        return this;
    }

    @Override
    public RecommendationsRecord values(Long value1, Long value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public RecommendationsRecord(Long id, Long diagnosticId, String text) {
        super(Recommendations.RECOMMENDATIONS);
